  ...
  <div v-if="show">
    <el-form label-position="top">
      <el-form-item label="类型">
        <el-tag effect="plain" size="medium">{{ $t('fm.components.fields.' + data.type) }}</el-tag>
      </el-form-item>
      ...
      <el-form-item :label="$t('fm.config.widget.size')"
        ...
        <el-input style="width: 90px;" type="number"
      ...
      <el-form-item :label="$t('fm.config.widget.step')"
        ...
        <el-input-number v-model="data.options.step" :min="0" :max="100"
      ...
      <el-form-item :label="$t('fm.config.widget.option')"
        ...
        <template v-else>
                ...
                <li v-for="(item, index) in data.options.options" :key="index">
                  ...
                  >
                    <el-input :style="{'width': data.options.showLabel? '90px': '180px' }"
                              :placeholder="$t('fm.config.widget.value')" size="mini"
                              v-model="item.value"></el-input>
                    <el-input style="width:90px;" size="mini" v-if="data.options.showLabel"
                              :placeholder="$t('fm.config.widget.label')"
          ...
          <div style="margin-left: 22px;">
            ...
            <el-button type="text" @click="resetDefaultOption">{{
                $t('fm.actions.resetDefaultOption')
              }}
            </el-button>
          </div>
        </template>
        ...
        <el-form-item :label="$t('fm.config.widget.columnOption')">
          ...
          >
            <li v-for="(item, index) in data.columns" :key="index">
              <i class="drag-item" style="font-size: 16px;margin: 0 5px;cursor: move;"><i
                  class="iconfont icon-icon_bars"></i></i>
              <el-input :placeholder="$t('fm.config.widget.span')" size="mini" style="width: 100px;"
                        type="number" v-model.number="item.span"></el-input>
      ...
      <template v-if="data.type != 'grid'">
        ...
        <el-form-item :label="$t('fm.config.widget.validate')">
          ...
          <div v-if="Object.keys(data.options).indexOf('pattern')>=0">
            <el-input size="mini" class="config-pattern-input" v-model.lazy="data.options.pattern"
                      style=" width: 240px;"
    ...
    handleAddOption() {
      if (this.data.options.showLabel) {
        this.data.options.options.push({
          value: this.$t('fm.config.widget.newOptionValue'),
          label: this.$t('fm.config.widget.newOptionLabel')
        })
      } else {
        this.data.options.options.push({
